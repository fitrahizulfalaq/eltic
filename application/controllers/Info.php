...
class Info extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->templateadmin->load('template/kosongan', 'info/info_data', $data);
	}
	...
	public function detail($id)
	{
		...
		if ($query->num_rows() > 0) {
			...
			$this->templateadmin->load('template/kosongan', 'info/info_detail', $data);
		} else {
	...
	public function tambah()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->templateadmin->load('template/tanpa-buttom', 'info/tambah', $data);
		} else {
